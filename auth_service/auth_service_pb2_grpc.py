...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Register = channel.unary_unary(
                ...
                request_serializer=auth__service__pb2.RegistrationRequest.SerializeToString,
                response_deserializer=auth__service__pb2.RegistrationResponse.FromString,
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Register': grpc.unary_unary_rpc_method_handler(
                    servicer.Register,
                    request_deserializer=auth__service__pb2.RegistrationRequest.FromString,
                    response_serializer=auth__service__pb2.RegistrationResponse.SerializeToString,
            ),
...
class AuthService(object):
    ...
    def Register(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/AuthService/Register',
            auth__service__pb2.RegistrationRequest.SerializeToString,
            auth__service__pb2.RegistrationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
