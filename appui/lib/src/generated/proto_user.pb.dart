...
class RegistrationRequest extends $pb.GeneratedMessage {
  factory RegistrationRequest({
    ...
    if (acceptPassword != null) {
      $result.acceptPassword = acceptPassword;
    }
    if (role != null) {
      $result.role = role;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RegistrationRequest', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'username')
    ..aOS(2, _omitFieldNames ? '' : 'password')
    ..aOS(3, _omitFieldNames ? '' : 'acceptPassword')
    ..e<UserRole>(4, _omitFieldNames ? '' : 'role', $pb.PbFieldType.OE, defaultOrMaker: UserRole.simply_user, valueOf: UserRole.valueOf, enumValues: UserRole.values)
  ...
  @$pb.TagNumber(3)
  $core.String get acceptPassword => $_getSZ(2);
  @$pb.TagNumber(3)
  set acceptPassword($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasAcceptPassword() => $_has(2);
  @$pb.TagNumber(3)
  void clearAcceptPassword() => $_clearField(3);
